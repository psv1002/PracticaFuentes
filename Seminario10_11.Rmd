...
```{r eval=FALSE}
library(readxl)
enfermedades2.0 <- read_excel("DATOS/enfermedades.xlsx")
enfermedad_2 <- spread_all(enfermedades2.0)
medicamentos2.0 <- read_excel("DATOS/medicamentos_comunidad.xlsx")
enfermedad_2 <- spread_all(medicamentos_comunidad2.0)
```
